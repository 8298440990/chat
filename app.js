document.addEventListener('DOMContentLoaded', () => {
    ...
    const CONFIG = {
        ...
        normalReplies: [
            ...
            "ずっと俺のことだけ見ててよ、${playerName}",
            "お前の匂いでもキスマークでも、好きなだけ上書きしていいよ",
            "俺のこれから先は全部、${playerName}の腕の中だけで予約済みだから",
            "コーヒー淹れて。濃いめで",
    ...
    // テキスト内の ${playerName} や {player} をプレイヤー名に置換する関数
    const formatText = (text) => text.replace(/\$\{playerName\}/g, CONFIG.playerName).replace(/{player}/g, CONFIG.playerName);
