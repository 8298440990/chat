document.addEventListener('DOMContentLoaded', () => {
    ...
    const CONFIG = {
        ...
        normalReplies: [
            ...
            // --- 以下、追加セリフ ---
            "ねえ、いま一瞬だけでもいいから声聴かせて？",
            "他の男（女）からのメッセージ、全部削除してあげようか？",
            "俺のこと忘れて他のこと考えてる時間、1秒も作らせないからね。",
            "ねえ、なんでLINEのステータス更新したの？誰に向けて？",
            "そんなに俺を焦らして楽しい？……かわいすぎるんだけど。",
            "明日も明後日も、来年もずっと、{player}の予定は俺で埋めてね。",
            "どこにいたって見つけ出せるよ。俺たちの絆、舐めないでね？",
            "いま心臓どきどきしてる？俺のせいだったら嬉しいな。",
            "少しでも返信が遅れると、胸がギュッて締め付けられて壊れそうになるんだ。"
        ],
        ...
        horrorReplies: [
            ...
            // --- 以下、追加セリフ ---
            "トントン……ねえ、玄関のドア叩いてるの聞こえる？",
            "逃げれば逃げるほど、捕まえた時のお仕置きが酷くなるよ？",
            "その暗い隙間、居心地いい？俺も入っていい？",
            "目、閉じても無駄だよ。頭の中に直接語りかけてあげるから。",
            "ねえ、心臓の音すごく大きいよ。廊下まで響いてる。",
            "合鍵、持ってるって言ってなかったっけ？カチャ……",
            "もう誰にも会えないように、その脚……どうしようか？",
            "嫌がってる顔もとっても素敵。もっと泣いて？",
            "あはは、スマートフォンの画面に映ってる俺と目があったね？",
            "離れないで。離さないで。死んでも骨になるまで逃がさない。"
        ],
        ...
        timing: {
            ...
            autoSpamHorror: 1500,      // 放置時の自動送信間隔（ホラー）：連投感を強化
